...
class APIObjectsInterface():
    ...
    def import_addresses(self, *secret_addresses):
        result = json.loads(self.send_post_request_with_params_dict('import-addresses', ast.literal_eval(
            json.dumps({'addresses': [{'secret': address} for address in secret_addresses]}))))
        print 'result', result
        public = []
    ...
    def import_address(self, secret_address):
